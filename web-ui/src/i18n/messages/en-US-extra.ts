const enUSExtra = {
  tasks: {
    ...
    form: {
      ...
      autoOrder: 'Automatic Order Hold',
      autoOrderHint: 'Experimental: submits an unpaid order only and never pays. The server master switch must also be enabled.',
      autoOrderThreshold: 'AI Score Threshold',
      autoOrderMaxPrice: 'Payable Amount Cap',
      autoOrderMaxPerRun: 'Attempts per Run',
      accountStrategy: {
        auto: 'Auto',
      ...
      validation: {
        ...
        autoOrderIncomplete: 'Incomplete order-hold settings',
        autoOrderRequiresAiFixed: 'Automatic order hold requires AI mode and a fixed account.',
        autoOrderPriceRequired: 'Enter a payable amount cap greater than zero.',
        autoOrderRangeInvalid: 'AI threshold must be an integer from 0-100 and attempts per run from 1-5.',
      },
    },
    region: {
  ...
  accounts: {
    ...
    health: {
      ...
      risk_controlled: 'Risk Limited',
      invalid_file: 'Invalid File',
      error: 'Check Error',
      neverChecked: 'Never checked',
      check: 'Check account health',
    },
    createDialog: {
  ...
  orders: {
    title: 'Order Holds',
    description: 'Review unpaid orders and fail-closed attempts. Payment always remains manual.',
    allStatuses: 'All Statuses',
    empty: 'No order-hold records yet',
    item: 'Item',
    ...
    next: 'Next page',
    total: '{count} records',
    status: { queued: 'Queued', submitting: 'Submitting', submitted_unpaid: 'Unpaid', blocked: 'Blocked', failed: 'Failed', skipped: 'Skipped' },
    toasts: { loadFailed: 'Failed to load order records.', retryCompleted: 'Manual retry completed.', retryFailed: 'Manual retry failed.' },
  },
  notifyPanel: {
