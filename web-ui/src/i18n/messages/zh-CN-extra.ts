const zhCNExtra = {
  tasks: {
    ...
    form: {
      ...
      autoOrder: '自动锁单',
      autoOrderHint: '实验性功能：只提交待付款订单，不会支付；还需服务端全局总开关开启。',
      autoOrderThreshold: 'AI 分数阈值',
      autoOrderMaxPrice: '应付金额上限',
      autoOrderMaxPerRun: '单轮尝试上限',
      accountStrategy: {
        auto: '自动选择',
      ...
      validation: {
        ...
        autoOrderIncomplete: '锁单配置不完整',
        autoOrderRequiresAiFixed: '自动锁单必须使用 AI 判断模式并绑定固定账号。',
        autoOrderPriceRequired: '请填写大于 0 的应付金额上限。',
        autoOrderRangeInvalid: 'AI 阈值须为 0-100 的整数，单轮尝试上限须为 1-5。',
      },
    },
    region: {
  ...
  orders: {
    title: '锁单记录',
    description: '查看自动提交的待付款订单和安全停止记录；支付始终需要人工完成。',
    allStatuses: '全部状态',
    empty: '暂无锁单记录',
    item: '商品',
    taskAccount: '任务 / 账号',
    ...
    next: '下一页',
    total: '共 {count} 条',
    status: { queued: '排队中', submitting: '提交中', submitted_unpaid: '待付款', blocked: '已阻止', failed: '失败', skipped: '已跳过' },
    toasts: { loadFailed: '加载锁单记录失败', retryCompleted: '人工重试已完成', retryFailed: '人工重试失败' },
  },
  notifyPanel: {
    title: '通知推送设置',
